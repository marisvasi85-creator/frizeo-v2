...
-- The activation revalidation UPDATE used LATERAL referencing the UPDATE
-- target alias, which Postgres rejects. Rewrite via CTE. Also guard
-- account_inactive against NULL scheduled_for.
