...
const PLATFORMS = [
  {
    ...
    label: "Instagram",
    activeClass: "bg-gradient-to-r from-[#f58529] via-[#dd2a7b] to-[#8134af] text-white hover:opacity-90",
    inactiveClass: "bg-frz-fog text-frz-muted border border-frz-line",
    icon: (
  ...
  },
  {
    ...
    label: "Facebook",
    activeClass: "bg-[#1877F2] text-white hover:opacity-90",
    inactiveClass: "bg-frz-fog text-frz-muted border border-frz-line",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden>
  ...
  },
  {
    key: "tiktok" as const,
    label: "TikTok",
    activeClass: "bg-black text-white border border-white/15 hover:opacity-90",
    inactiveClass: "bg-frz-fog text-frz-muted border border-frz-line",
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden>
  ...
  return (
    <AdminCard className="space-y-3">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm font-medium text-frz-ink">Conturile tale sociale</p>
        {configured < 3 && (
          <Link
            href="/admin/profile"
            className="text-xs text-frz-muted hover:text-frz-ink underline"
          >
      ...
      <div className="grid grid-cols-3 gap-3">
        {PLATFORMS.map((platform) => {
          ...
          const className = `inline-flex flex-col items-center justify-center gap-2 rounded-xl px-3 py-4 text-sm font-medium transition ${
