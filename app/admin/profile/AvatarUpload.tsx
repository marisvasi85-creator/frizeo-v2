    ...
    <div className="bg-white border border-frz-line rounded-xl p-6 space-y-4">
      ...
      {preview ? (
        <img
          src={preview}
          alt=""
          className="w-32 h-32 rounded-full object-cover border border-frz-line"
        />
      ) : (
        <div className="w-32 h-32 rounded-full bg-frz-fog border border-frz-line flex items-center justify-center text-frz-ink/40 text-sm text-center px-2">
          Fără poză
        </div>
      )}
