...
- Write permis DOAR prin set_tenant_plan, cu confirmare:
  1) apelează fără confirmed (sau confirmed=false)
  2) prezintă propunerea + warning Stripe
...
2) overview / listare / detaliu saloane
3) trial-uri + past_due
4) setare plan pe un salon (free / pro / pro-plus / custom) cu confirmare`;
}
