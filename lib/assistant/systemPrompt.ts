...
- Pentru acțiuni care modifică date (create_booking, create_service, update_booking, cancel_booking, close_day, create_vacation):
...
- Pentru ore libere: folosește find_slots (cu service_id sau service_name). Apoi create_booking cu ora aleasă.
...
2) programări (listare, ore libere, creare, mutare, anulare)
