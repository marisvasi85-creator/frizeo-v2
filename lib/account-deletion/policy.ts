...
export const ACCOUNT_DELETION_TABLE_POLICY: AccountDeletionTablePolicy[] = [
  ...
  { table: "subscriptions", disposition: "KEEP", notes: "Retained financial records. Cancel active Stripe only if last member; never delete billing rows via account deletion." },
  { table: "tenant_fiscal_invoices", disposition: "KEEP", notes: "Retained financial records. Account deletion never deletes invoices. Retention is a separate process; no legal retention period is encoded here." },
